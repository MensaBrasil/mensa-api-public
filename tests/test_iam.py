...
def test_create_role_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_permission_valid_token(test_client: Any, mock_valid_token: Any) -> None:
    ...
    assert response.status_code == 201
    assert response.json() == {"detail": "Permission: see_dashboard created successfully."}
...
def test_add_role_to_member_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_group_to_member_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_role_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_group_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_valid_token(test_client: Any, mock_valid_token: Any) -> None:
    """Test updating a role with a valid token."""

    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {
        "role_name": "Diretor Regional",
        "new_role_name": "UpdatedRole",
        "new_role_description": "UpdatedDescription",
    }
...
def test_update_group_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_permission_valid_token(test_client: Any, mock_valid_token: Any) -> None:
    """Test updating a permission with a valid token."""

    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {
        "permission_name": "whatsapp_bot",
        "new_permission_name": "UpdatedPermission",
        "new_permission_description": "UpdatedDesc",
    }
    response = test_client.patch("/iam/update_permission/", json=json, headers=headers)
    assert response.status_code == 200
    assert response.json() == {"detail": "Permission: whatsapp_bot updated successfully."}
...
def test_remove_role_from_member_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_group_from_member_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_permission_from_role_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_permission_from_group_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_valid_token(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_permission_valid_token(test_client: Any, mock_valid_token: Any) -> None:
    ...
    assert response.status_code == 200
    assert response.json() == {"detail": "Permission: whatsapp_bot deleted successfully."}
...
def test_create_role_missing_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_missing_role_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_invalid_role_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_invalid_role_description_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_empty_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_numeric_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_empty_role_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_numeric_role_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_role_already_exists(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_missing_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_missing_group_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_invalid_group_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_empty_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_numeric_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_empty_group_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_numeric_group_description(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_group_already_exists(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_permission_missing_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_permission_empty_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_permission_numeric_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_create_permission_already_exists(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_role_to_member_role_already_assigned(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_role_to_member_role_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_group_to_member_group_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_role_missing_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_role_empty_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_role_numeric_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_role_permission_does_not_exist(
    ...
    response = test_client.post("/iam/add_permission_to_role/", json=data, headers=headers)
    assert response.status_code == 404
    assert response.json() == {"detail": "Permission: non_existent_permission does not exist."}
...
def test_add_permission_to_group_empty_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_add_permission_to_group_permission_already_assigned(
    ...
    response = test_client.post("/iam/add_permission_to_group/", json=data, headers=headers)
    assert response.status_code == 400
    assert response.json() == {"detail": "Group: Beta Tester already has permission: whatsapp_bot."}
...
def test_get_roles_check_response_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_get_groups_check_response_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_get_members_by_role_name_should_return_member_list(
    ...
    """Test getting members by"Field: \\ role_name\"."""
...
def test_get_members_by_role_name_role_dont_exist(test_client: Any, mock_valid_token: Any) -> None:
    """Test getting members by"Field: \\ role_name\" that does not exist."""
...
def test_get_members_by_group_name_should_return_member_list(
    ...
    """Test getting members by"Field: \\ group_name\"."""
...
def test_get_members_by_group_name_group_dont_exist(
    ...
    """Test getting members by"Field: \\ group_name\" that does not exist."""
...
def test_get_group_permissions_by_group_name_no_permissions_found(
    ...
    assert response.status_code == 404
    assert response.json() == {"detail": "No permissions found for group Sig Matemática."}
...
def test_update_role_missing_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_missing_new_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_invalid_role_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_invalid_new_role_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_role_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_role_valid_data_inserted(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_group_missing_group_name(test_client: Any, mock_valid_token: Any) -> None:
    """Test updating a group with missing group_name."""

    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {
        "new_group_name": "UpdatedGroup",
        "new_group_description": "UpdatedDescription",
    }
    response = test_client.patch("/iam/update_group/", json=json, headers=headers)
    assert response.status_code == 422
    assert response.json() == {
...
def test_update_group_missing_new_group_name(test_client: Any, mock_valid_token: Any) -> None:
    """Test updating a group with missing new_group_name."""

    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {"group_name": "Beta Tester", "new_group_description": "UpdatedDescription"}
    response = test_client.patch("/iam/update_group/", json=json, headers=headers)
    assert response.status_code == 422
    assert response.json() == {
        "detail": [
...
def test_update_group_invalid_group_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_group_invalid_new_group_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_group_group_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_group_valid_data_inserted(test_client: Any, mock_valid_token: Any) -> None:
...
def test_update_permission_missing_permission_name(test_client: Any, mock_valid_token: Any) -> None:
    """Test updating a permission with missing permission_name."""

    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {
        "new_permission_name": "UpdatedPermission",
        "new_permission_description": "UpdatedDescription",
    }
    response = test_client.patch("/iam/update_permission/", json=json, headers=headers)
    assert response.status_code == 422
    assert response.json() == {
...
def test_update_permission_valid_data_inserted(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_role_from_member_empty_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_role_from_member_numeric_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_role_from_member_role_not_assigned(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_role_from_member_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_group_from_member_empty_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_group_from_member_member_id_zero(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_group_from_member_group_not_assigned(
    ...
    assert response.status_code == 404
    assert response.json() == {"detail": "Group: Sig Matemática not assigned to member with id: 5."}
...
def test_remove_group_from_member_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_permission_from_role_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_remove_permission_from_group_permission_not_assigned(
    ...
    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {"group_name": "Beta Tester", "permission_name": "edit_event"}
    response = test_client.request(
        method="delete",
        url="/iam/remove_permission_from_group/",
        json=json,
    ...
    assert response.status_code == 404
    assert response.json() == {"detail": "Group: Beta Tester does not have permission: edit_event."}
...
def test_remove_permission_from_group_permission_does_not_exist(
    ...
    headers = {"Authorization": f"Bearer {mock_valid_token}"}
    json = {"group_name": "Beta Tester", "permission_name": "non_existent"}
    response = test_client.request(
        method="delete",
        url="/iam/remove_permission_from_group/",
        json=json,
...
def test_remove_permission_from_group_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_missing_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_invalid_role_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_empty_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_numeric_role_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_role_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_role_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_missing_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_invalid_group_name_type(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_empty_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_numeric_group_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_group_does_not_exist(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_group_valid_data(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_permission_missing_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_permission_empty_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_permission_numeric_permission_name(test_client: Any, mock_valid_token: Any) -> None:
...
def test_delete_permission_valid_data(test_client: Any, mock_valid_token: Any) -> None:
