...
down_revision: str | None = "4cf0d9c18cef"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "group_description", sqlmodel.sql.sqltypes.AutoString(length=512), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "permission_description", sqlmodel.sql.sqltypes.AutoString(length=512), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
